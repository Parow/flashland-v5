...
AddEventHandler("es:addGroup", function(group, inherit, aceGroup)
	...
	if(type(group) ~= "string")then
		...
		--'ES_ERROR: There seems to be an issue while creating a new group, please make sure that you entered a correct "group" as "string"')
	end
	...
	if(type(inherit) ~= "string")then
		...
		--'ES_ERROR: There seems to be an issue while creating a new group, please make sure that you entered a correct "inherit" as "string"')
	end
